      ...
      <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/seo-and-web.png" alt="user_icon">
       ...
       <h1> 6</h1>
        <form action ="ShowUser">       
             <button id="button"    class="text-uppercase text-muted"> <h1> Users </h1></button>
 ...
 <div class="col-md-4">
  ...
  <div class="card-body">
    ...
    <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/list.png" alt="user_icon">
                            ...
                            <h1><%=list.size() %></h1>
                             <form action ="Show-Category">       
                  <button id="button"    class="text-uppercase text-muted"> <h1> Category </h1></button>
                ...
                <div class="col-md-4">
                    ...
                    <form action ="Show-Products">       
                  <button id="button"    class="text-uppercase text-muted"> <h1> Products </h1></button>
